...
equipment = [
    {'id': osrs.item_ids.CLUE_HUNTER_GARB, 'consume': 'Wear'},
    {'id': osrs.item_ids.CLUE_HUNTER_TROUSERS, 'consume': 'Wear'},
    {'id': osrs.item_ids.LIT_BUG_LANTERN, 'consume': 'Wield'},
    {'id': osrs.item_ids.EARMUFFS, 'consume': 'Wear'},
    {'id': osrs.item_ids.PYROMANCER_HOOD, 'consume': 'Wear'},
    {'id': osrs.item_ids.RUNE_AXE, 'consume': 'Wield'},
