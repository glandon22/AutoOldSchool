...
bolo_seed = osrs.item_ids.GOLOVANOVA_SEED
EMPTY_PATCH = '27383'
...
def get_seeds():
    ...
    if qh.get_widgets(osrs.widget_ids.chat_input_request_widget):
        ...
        return True
    elif qh.get_chat_options('Golovanova', fuzzy=True):
        osrs.keeb.write(str(qh.get_chat_options('Golovanova', fuzzy=True)))
...
def main(endless_loop=True):
    ...
    while True:
        ...
        osrs.move.interact_with_object_v3(
            ...
            custom_exit_function_arg=osrs.item_ids.GOLOVANOVA_FRUIT
        )
