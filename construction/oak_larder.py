...
def make_chair():
    ...
    general_utils.right_click_menu_select(chair_to_build[larder_slot], None, port, 'Larder space', 'Build')
    while True:
...
def remove_chair():
    while True:
        ...
        if chair_to_remove:
            general_utils.right_click_menu_select(chair_to_remove[built_larder], None, port, 'Larder', 'Remove')
            break
