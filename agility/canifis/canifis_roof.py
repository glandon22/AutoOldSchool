...
def go_to_center():
    ...
    while True:
        ...
        if 'tiles' in data and '349334880' in data['tiles']:
            osrs.move.move_and_click(data['tiles']['349334880']['x'], data['tiles']['349334880']['y'], 7, 7)
...
def click_step2():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14844' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14844']['x'], data['gameObjects']['14844']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
...
def click_step3():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14845' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14845']['x'], data['gameObjects']['14845']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
...
def click_step4():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14848' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14848']['x'], data['gameObjects']['14848']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
...
def click_step5():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14846' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14846']['x'], data['gameObjects']['14846']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
...
def click_step6():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14894' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14894']['x'], data['gameObjects']['14894']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
...
def click_step7():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14847' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14847']['x'], data['gameObjects']['14847']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
...
def click_step8():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14897' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14897']['x'], data['gameObjects']['14897']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
...
def main():
    ...
    while True:
        ...
        fell4 = step4()
        if fell4 == 'fell':
            osrs.clock.random_sleep(3.3, 3.4)
            go_to_center()
            continue
        osrs.clock.random_sleep(0.5, 0.6)
        step5()
