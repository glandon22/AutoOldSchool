...
def start_course(lc):
    ...
    if 'z' in loc and loc['z'] == 0 and click_allowed(lc, 3, 1):
        ...
        if bool(obstacle):
            ...
            general_utils.run_towards_square_v2(course_start, port)
    return lc
...
def platform_1(lc):
    ...
    if 'z' in loc and loc['z'] == 1 and \
        ...
        general_utils.handle_marks(3346, 3351, 2963, 2968, 1, port)
        obstacle = general_utils.get_game_object('3350,2971,1', '14936', port)
        if bool(obstacle):
            general_utils.move_and_click(obstacle['x'], obstacle['y'], 3, 3)
...
def platform_2(lc):
    ...
    if 'z' in loc and loc['z'] == 1 and \
        ...
        general_utils.handle_marks(3352, 3355, 2973, 2976, 1, port)
        obstacle = general_utils.get_game_object('3357,2978,1', '14937', port)
        if bool(obstacle):
            general_utils.move_and_click(obstacle['x'], obstacle['y'], 3, 3)
            general_utils.random_sleep(1, 1.2)
            return {
...
def platform_3(lc):
    ...
    if 'z' in loc and loc['z'] == 1 and \
        ...
        general_utils.handle_marks(3360, 3362, 2977, 2979, 1, port)
        obstacle = general_utils.get_game_object('3364,2977,1', '14938', port)
        if bool(obstacle):
            general_utils.move_and_click(obstacle['x'], obstacle['y'], 3, 3)
...
def platform_4(lc):
    ...
    if 'z' in loc and loc['z'] == 1 and \
            ...
            2974 <= loc['y'] <= 2976 and \
            click_allowed(lc, 4, 4):
        general_utils.handle_marks(3366, 3370, 2974, 2976, 1, port)
        obstacle = general_utils.get_game_object('3368,2977,1', '14939', port)
        if bool(obstacle):
            general_utils.move_and_click(obstacle['x'], obstacle['y'], 3, 3)
            general_utils.random_sleep(1, 1.2)
            return {
...
def platform_5(lc):
    ...
    if 'z' in loc and loc['z'] == 1 and \
        ...
        general_utils.handle_marks(3365, 3369, 2982, 2986, 1, port)
        q = {
            'decorativeObjects': [{
                'tile': '3365,2982,1',
                'object': '14940'
        ...
        if 'decorativeObjects' in data and '14940' in data['decorativeObjects']:
            general_utils.move_and_click(data['decorativeObjects']['14940'][0]['x'],
...
def platform_6(lc):
    ...
    if 'z' in loc and loc['z'] == 2 and \
        ...
        general_utils.handle_marks(3355, 3365, 2980, 2985, 2, port)
        obstacle = general_utils.get_game_object('3358,2985,2', '14941', port)
        if bool(obstacle):
            general_utils.move_and_click(obstacle['x'], obstacle['y'], 3, 3)
            general_utils.random_sleep(1, 1.2)
            return {
...
def platform_7(lc):
    ...
    if 'z' in loc and loc['z'] == 2 and \
        ...
        general_utils.handle_marks(3357, 3370, 2990, 2995, 2, port)
        obstacle = general_utils.get_game_object('3360,2997,2', '14944', port)
        if bool(obstacle):
            general_utils.move_and_click(obstacle['x'], obstacle['y'], 3, 3)
            general_utils.random_sleep(1, 1.2)
            return {
...
def platform_8(lc):
    ...
    if 'z' in loc and loc['z'] == 2 and \
        ...
        general_utils.handle_marks(3356, 3362, 3000, 3004, 2, port)
        obstacle = general_utils.get_game_object('3364,3000,2', '14945', port)
        if bool(obstacle):
            general_utils.move_and_click(obstacle['x'], obstacle['y'], 3, 3)
            general_utils.random_sleep(1, 1.2)
            return {
