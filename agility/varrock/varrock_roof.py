...
def go_to_center():
    ...
    while True:
        ...
        if 'tiles' in data and '320734080' in data['tiles']:
            osrs.move.move_and_click(data['tiles']['320734080']['x'], data['tiles']['320734080']['y'], 7, 7)
...
def click_step2():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14413' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14413']['x'], data['gameObjects']['14413']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
...
def click_step3():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14414' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14414']['x'], data['gameObjects']['14414']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
...
def click_step4():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14832' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14832']['x'], data['gameObjects']['14832']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
...
def click_step5():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14833' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14833']['x'], data['gameObjects']['14833']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
        ...
        if 'playerWorldPoint' in data and data['playerWorldPoint']['x'] == 3193 and data['playerWorldPoint']['y'] == 3398:
            ...
            if mark:
                ...
                if 'tiles' in data and '320033963' in data['tiles']:
                    osrs.move.move_and_click(data['tiles']['320033963']['x'], data['tiles']['320033963']['y'], 4, 5)
                    osrs.move.wait_until_stationary()
            break
        # i have fallen. need to restart course
        elif 'playerWorldPoint' in data and data['playerWorldPoint']['z'] == 0:
...
def click_step6():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14834' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14834']['x'], data['gameObjects']['14834']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
...
def click_step7():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14835' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14835']['x'], data['gameObjects']['14835']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
...
def click_step8():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14836' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14836']['x'], data['gameObjects']['14836']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
...
def click_step9():
    ...
    while True:
        ...
        if 'gameObjects' in data and '14841' in data['gameObjects']:
            osrs.move.move_and_click(data['gameObjects']['14841']['x'], data['gameObjects']['14841']['y'], 2, 2)
            osrs.clock.random_sleep(1, 1.1)
            break
...
def main():
    ...
    while True:
        start_time = osrs.game.break_manager(start_time, 47, 54, 423, 551, 'pass_70', look_up)
        fell2 = False
        fell4 = False
        step1()
        fell2 = step2()
