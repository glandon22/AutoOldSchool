...
def start_course(lc):
    ...
    if 'z' in loc and loc['z'] == 0 and click_allowed(lc, 3, 1):
        ...
        if 'decorativeObjects' in data and '14898' in data['decorativeObjects']:
            general_utils.move_and_click(data['decorativeObjects']['14898'][0]['x'],
...
def platform_1(lc):
    ...
    if 'z' in loc and loc['z'] == 3 and \
        ...
        general_utils.handle_marks(3035, 3040, 3342, 3347, 3, port)
        obstacle = general_utils.get_game_object('3040,3343,3', '47195', port)
        if bool(obstacle):
...
def platform_2(lc):
    ...
    if 'z' in loc and loc['z'] == 3 and \
        ...
        general_utils.handle_marks(3044, 3051, 3341, 3349, 3, port)
        obstacle = general_utils.get_game_object('3050,3350,3', '14901', port)
        if bool(obstacle):
            general_utils.move_and_click(obstacle['x'], obstacle['y'], 3, 3)
            general_utils.random_sleep(1, 1.2)
            return {
...
def platform_3(lc):
    ...
    if 'z' in loc and loc['z'] == 3 and \
        ...
        general_utils.handle_marks(3048, 3051, 3356, 3358, 3, port)
        obstacle = general_utils.get_game_object('3048,3359,3', '14903', port)
        if bool(obstacle):
            general_utils.move_and_click(obstacle['x'], obstacle['y'], 3, 3)
            general_utils.random_sleep(1, 1.2)
            return {
...
def platform_4(lc):
    ...
    if 'z' in loc and loc['z'] == 3 and \
        ...
        general_utils.handle_marks(3045, 3048, 3361, 3367, 3, port)
        obstacle = general_utils.get_game_object('3044,3362,3', '14904', port)
        if bool(obstacle):
            general_utils.move_and_click(obstacle['x'], obstacle['y'], 3, 3)
            general_utils.random_sleep(1, 1.2)
            return {
...
def platform_5(lc):
    ...
    if 'z' in loc and loc['z'] == 3 and \
        ...
        general_utils.handle_marks(3034, 3041, 3361, 3364, 3, port)
        obstacle = general_utils.get_game_object('3034,3361,3', '14905', port)
        if bool(obstacle):
            general_utils.move_and_click(obstacle['x'], obstacle['y'], 3, 3)
            general_utils.random_sleep(1, 1.2)
            return {
