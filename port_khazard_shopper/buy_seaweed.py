...
def dump_item():
    seaweed = general_utils.roughImgCompare('.\\screens\\seaweed_in_bag.png', .75, (844, 438, 1402, 774))
    if seaweed:
    ...
    soda = general_utils.roughImgCompare('.\\screens\\soda_in_bag.png', .75, (844, 438, 1402, 774))
    if soda:
