...
def start_quest():
    ...
    while True:
        ...
        if final_dialogue_seen:
            return
        elif qh.get_chat_options('I\'m looking for a quest.'):
            osrs.keeb.write(str(qh.get_chat_options('I\'m looking for a quest.')))
        ...
        elif qh.get_chat_options('Yes okay. I can do that.'):
            osrs.keeb.write(str(qh.get_chat_options('Yes okay. I can do that.')))
