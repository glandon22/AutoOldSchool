...
def main():
    util_functions.talk_to_npc('king bolren')
    util_functions.dialogue_handler(dialogue)
    osrs.move.go_to_loc(2529, 3202)
    ...
    # this dialogue handler wont work right off the bat bc i need to enter the coordinates in sequence. need to investigate how to do this
